...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(30,32,38,0.45)', backdropFilter: 'blur(2px)'}}>
      <div
        className="relative w-full max-w-[480px] mx-auto bg-white rounded-2xl shadow-2xl border border-gray-100"
      ...
      >
        ...
        <div className="px-6 pb-8 pt-6 bg-white">
          <div className="space-y-4">
            ...
            <div className="pt-1">
              <Button className="w-full bg-gradient-to-r from-[#36d1c4] via-[#5b86e5] to-[#f857a6] text-white">Đăng nhập</Button>
            </div>

            <div className="text-center text-sm text-gray-500">
              Chưa có tài khoản? <Link href="/register" className="text-blue-500 font-medium">Đăng ký ngay</Link>
            </div>
          </div>
        </div>
      </div>
